        ...
        <div class="card-body">
            ...
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Nombre: activar para ordenar la columna de forma ascendente" _mstaria-label="1105559" _msthash="92" _msttexthash="76193" style="width: 69.5469px;">Modelo</th>
                    <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="#: activar para ordenar la columna ascendente" _mstaria-label="941499" _msthash="91" style="width: 9.5625px;">Estado Energia</th>
                </tr>
            </thead>
            <tbody>
                 @foreach ($dispositivos as $dispositivo)
                    <tr role="row" class="odd">
                      ...
                      <td>{{ $dispositivo->estadoEnergia->estado_energia ?? 'N/A' }}</td>
                    </tr>
                  @endforeach
            </tbody>
